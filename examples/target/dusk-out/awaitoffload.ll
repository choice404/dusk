...
@.str.0 = private unnamed_addr constant [22 x i8] c"/tmp/dusk_await_a.tmp\00"
@.str.1 = private unnamed_addr constant [3 x i8] c"14\00"
@.str.2 = private unnamed_addr constant [18 x i8] c"cannot write file\00"
@.str.3 = private unnamed_addr constant [22 x i8] c"/tmp/dusk_await_b.tmp\00"
@.str.4 = private unnamed_addr constant [3 x i8] c"27\00"
@.str.5 = private unnamed_addr constant [22 x i8] c"/tmp/dusk_await_c.tmp\00"
@.str.6 = private unnamed_addr constant [3 x i8] c"19\00"
@.str.7 = private unnamed_addr constant [2 x i8] c"\0A\00"
@.str.8 = private unnamed_addr constant [17 x i8] c"cannot read file\00"
@.str.9 = private unnamed_addr constant [1 x i8] c"\00"
@.str.10 = private unnamed_addr constant [31 x i8] c"the thread pool is not running\00"
@.str.11 = private unnamed_addr constant [32 x i8] c"the thread pool could not start\00"
@.str.12 = private unnamed_addr constant [30 x i8] c"base must be between 2 and 36\00"
@.str.13 = private unnamed_addr constant [23 x i8] c"invalid digit for base\00"
@.str.14 = private unnamed_addr constant [17 x i8] c"integer overflow\00"
@.str.15 = private unnamed_addr constant [19 x i8] c"no digits to parse\00"
@.str.16 = private unnamed_addr constant [31 x i8] c"the event loop could not start\00"
@.str.17 = private unnamed_addr constant [25 x i8] c"future already completed\00"
...
entry:
  ...
  %t3 = call ptr @cool_read_file(ptr @.str.0)
  %t4 = icmp eq ptr %t3, null
  %t5 = select i1 %t4, ptr @.str.8, ptr null
  %t6 = select i1 %t4, ptr @.str.9, ptr %t3
  %t7 = insertvalue { ptr, ptr } undef, ptr %t6, 0
  %t8 = insertvalue { ptr, ptr } %t7, ptr %t5, 1
  %t9 = extractvalue { ptr, ptr } %t8, 0
  %t10 = alloca ptr
  store ptr %t9, ptr %t10
  %t11 = extractvalue { ptr, ptr } %t8, 1
  %t12 = alloca ptr
  store ptr %t11, ptr %t12
  %t13 = load ptr, ptr %t12
  %t14 = load ptr, ptr %t10
  %t15 = call { i64, ptr } @parse_int(ptr %t14)
  %t16 = extractvalue { i64, ptr } %t15, 0
  %t17 = alloca i64
  store i64 %t16, ptr %t17
  %t18 = extractvalue { i64, ptr } %t15, 1
  %t19 = alloca ptr
  store ptr %t18, ptr %t19
  %t20 = load ptr, ptr %t19
  %t21 = load ptr, ptr %t10
  call void @cool_gen_free(ptr %t21)
  %t22 = load %Future$int64, ptr %t2
  %t23 = load i64, ptr %t17
  %t24 = load ptr, ptr %t19
  %t25 = call ptr @complete$int64(%Future$int64 %t22, i64 %t23, ptr %t24)
  %t26 = alloca ptr
...
define void @lambda.1(ptr %env) {
entry:
  %t0 = getelementptr { %Future$int64 }, ptr %env, i32 0, i32 0
  %t1 = load %Future$int64, ptr %t0
  %t2 = alloca %Future$int64
  store %Future$int64 %t1, ptr %t2
  %t3 = call ptr @cool_read_file(ptr @.str.3)
  %t4 = icmp eq ptr %t3, null
  %t5 = select i1 %t4, ptr @.str.8, ptr null
  %t6 = select i1 %t4, ptr @.str.9, ptr %t3
  %t7 = insertvalue { ptr, ptr } undef, ptr %t6, 0
...
define void @lambda.2(ptr %env) {
entry:
  %t0 = getelementptr { %Future$int64 }, ptr %env, i32 0, i32 0
  %t1 = load %Future$int64, ptr %t0
  %t2 = alloca %Future$int64
  store %Future$int64 %t1, ptr %t2
  %t3 = call ptr @cool_read_file(ptr @.str.5)
  %t4 = icmp eq ptr %t3, null
  %t5 = select i1 %t4, ptr @.str.8, ptr null
  %t6 = select i1 %t4, ptr @.str.9, ptr %t3
  %t7 = insertvalue { ptr, ptr } undef, ptr %t6, 0
...
define i32 @main() {
entry:
  %t0 = call i64 @cool_write_file(ptr @.str.0, ptr @.str.1)
  %t1 = icmp slt i64 %t0, 0
  %t2 = select i1 %t1, ptr @.str.2, ptr null
  %t3 = alloca ptr
  store ptr %t2, ptr %t3
  %t4 = load ptr, ptr %t3
  %t5 = call i64 @cool_write_file(ptr @.str.3, ptr @.str.4)
  %t6 = icmp slt i64 %t5, 0
  %t7 = select i1 %t6, ptr @.str.2, ptr null
  %t8 = alloca ptr
  store ptr %t7, ptr %t8
  %t9 = load ptr, ptr %t8
  %t10 = call i64 @cool_write_file(ptr @.str.5, ptr @.str.6)
  %t11 = icmp slt i64 %t10, 0
  %t12 = select i1 %t11, ptr @.str.2, ptr null
  %t13 = alloca ptr
  store ptr %t12, ptr %t13
  %t14 = load ptr, ptr %t13
  %t15 = call ptr @loop_init()
  %t16 = alloca ptr
  store ptr %t15, ptr %t16
  %t17 = load ptr, ptr %t16
  %t18 = call ptr @pool_start(i64 2)
  %t19 = alloca ptr
  store ptr %t18, ptr %t19
  %t20 = load ptr, ptr %t19
...
L0:
  ...
  call void @cool_eprint_cstr(ptr %t22)
  call void @cool_eprint_cstr(ptr @.str.7)
  %t23 = trunc i64 1 to i32
  ret i32 %t23
L1:
  %t24 = call %Future$int64 @future_new$int64()
  %t25 = alloca %Future$int64
  store %Future$int64 %t24, ptr %t25
  %t26 = call %Future$int64 @future_new$int64()
  %t27 = alloca %Future$int64
  store %Future$int64 %t26, ptr %t27
  %t28 = call %Future$int64 @future_new$int64()
  %t29 = alloca %Future$int64
  store %Future$int64 %t28, ptr %t29
  %t30 = getelementptr { %Future$int64 }, ptr null, i64 1
  %t31 = ptrtoint ptr %t30 to i64
  %t32 = call ptr @cool_alloc_env(i64 %t31)
  %t33 = load %Future$int64, ptr %t25
  %t34 = getelementptr { %Future$int64 }, ptr %t32, i32 0, i32 0
  store %Future$int64 %t33, ptr %t34
  %t35 = call i64 @cool_pool_submit(ptr @lambda.0, ptr %t32)
  %t36 = icmp ne i64 %t35, 0
  %t37 = select i1 %t36, ptr @.str.10, ptr null
  %t38 = alloca ptr
  store ptr %t37, ptr %t38
  %t39 = load ptr, ptr %t38
  %t40 = getelementptr { %Future$int64 }, ptr null, i64 1
  %t41 = ptrtoint ptr %t40 to i64
  %t42 = call ptr @cool_alloc_env(i64 %t41)
  %t43 = load %Future$int64, ptr %t27
  %t44 = getelementptr { %Future$int64 }, ptr %t42, i32 0, i32 0
  store %Future$int64 %t43, ptr %t44
  %t45 = call i64 @cool_pool_submit(ptr @lambda.1, ptr %t42)
  %t46 = icmp ne i64 %t45, 0
  %t47 = select i1 %t46, ptr @.str.10, ptr null
  %t48 = alloca ptr
  store ptr %t47, ptr %t48
  %t49 = load ptr, ptr %t48
  %t50 = getelementptr { %Future$int64 }, ptr null, i64 1
  %t51 = ptrtoint ptr %t50 to i64
  %t52 = call ptr @cool_alloc_env(i64 %t51)
  %t53 = load %Future$int64, ptr %t29
  %t54 = getelementptr { %Future$int64 }, ptr %t52, i32 0, i32 0
  store %Future$int64 %t53, ptr %t54
  %t55 = call i64 @cool_pool_submit(ptr @lambda.2, ptr %t52)
  %t56 = icmp ne i64 %t55, 0
  %t57 = select i1 %t56, ptr @.str.10, ptr null
  %t58 = alloca ptr
  store ptr %t57, ptr %t58
  %t59 = load ptr, ptr %t58
  %t60 = load %Future$int64, ptr %t25
  %t61 = call { i64, ptr } @await$int64(%Future$int64 %t60)
  %t62 = extractvalue { i64, ptr } %t61, 0
  %t63 = alloca i64
  store i64 %t62, ptr %t63
  %t64 = extractvalue { i64, ptr } %t61, 1
  %t65 = alloca ptr
  store ptr %t64, ptr %t65
  %t66 = load ptr, ptr %t65
  %t67 = load %Future$int64, ptr %t27
  %t68 = call { i64, ptr } @await$int64(%Future$int64 %t67)
  %t69 = extractvalue { i64, ptr } %t68, 0
  %t70 = alloca i64
  store i64 %t69, ptr %t70
  %t71 = extractvalue { i64, ptr } %t68, 1
  %t72 = alloca ptr
  store ptr %t71, ptr %t72
  %t73 = load ptr, ptr %t72
  %t74 = load %Future$int64, ptr %t29
  %t75 = call { i64, ptr } @await$int64(%Future$int64 %t74)
  %t76 = extractvalue { i64, ptr } %t75, 0
  %t77 = alloca i64
  store i64 %t76, ptr %t77
  %t78 = extractvalue { i64, ptr } %t75, 1
  %t79 = alloca ptr
  store ptr %t78, ptr %t79
  %t80 = load ptr, ptr %t79
  %t81 = load i64, ptr %t63
  %t82 = load i64, ptr %t70
  %t83 = add i64 %t81, %t82
  %t84 = load i64, ptr %t77
  %t85 = add i64 %t83, %t84
  call void @cool_println_i64(i64 %t85)
...
L0:
  ...
  %t5 = insertvalue { i64, ptr } %t4, ptr @.str.12, 1
  ret { i64, ptr } %t5
L1:
  %t6 = load i64, ptr %t1
...
L2:
  ...
  %t9 = insertvalue { i64, ptr } %t8, ptr @.str.12, 1
  ret { i64, ptr } %t9
L3:
  %t10 = alloca i64
  store i64 0, ptr %t10
...
L31:
  ...
  %t87 = insertvalue { i64, ptr } %t86, ptr @.str.13, 1
  ret { i64, ptr } %t87
L32:
...
L33:
  ...
  %t95 = insertvalue { i64, ptr } %t94, ptr @.str.14, 1
  ret { i64, ptr } %t95
L34:
...
L35:
  ...
  %t108 = insertvalue { i64, ptr } %t107, ptr @.str.15, 1
  ret { i64, ptr } %t108
L36:
